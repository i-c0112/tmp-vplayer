...
// bugfix: add forEach support for TextTrackList
if (!TextTrackList.prototype.forEach) {
  TextTrackList.prototype.forEach = function(callback, thisArg) {
    var T, k;
    if (this == null) {
      throw new TypeError(' this is null or not defined');
    }
...
var scrollerProto = function(plugin) {
  ...
  var scrollToElement = function (element) {
    if (this.canScroll()) {
      ...
      newPos = element.offsetTop - parent.offsetTop - parent.clientHeight / 2;
